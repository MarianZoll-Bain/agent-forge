  ...
  return (
    <div className="group rounded-2xl border border-slate-200/80 dark:border-white/[0.06] bg-white dark:bg-white/[0.03] flex flex-col shadow-card hover:shadow-card-hover hover:-translate-y-0.5 transition-all duration-200">
      ...
      <div className="flex items-center gap-1 px-4 pb-2 min-w-0">
        <span className="text-xs text-slate-400 dark:text-slate-600 font-mono truncate" title={agent.worktreePath}>
          {agent.worktreePath}
        </span>
      ...
      {enableGitMode && (
        <div className="flex items-center gap-2 px-4 pb-3">
          ...
          <button
            ...
            className="ml-auto p-1 rounded-md text-slate-400 dark:text-slate-500 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 transition-colors disabled:opacity-40"
          >
